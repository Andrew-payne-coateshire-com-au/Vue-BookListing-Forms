...
export default {
  ...
  data() {
    return {
      ...
      books: [
        { title: "Self-Reliance", author: "Ralph Waldo Emerson", finishReading: true },
        { title: "American Gods", author: "Neil Gaiman", finishReading: false },
        { title: "Amusing Ourselves to Death", author: "Neil Postman", finishReading: true }
      ]
    };
  },
  components: {
